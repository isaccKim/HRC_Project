...
Future getUserData() async {
  ...
  sum_record[0][0] = u_rc;
  sum_record[1][0] = u_rc;
  sum_record[0][2] = convertDist(u_sum_dist.toString()) +
      ' km'; //u_sum_dist.toString() + ' km';
  sum_record[1][2] = convertTime(u_sum_time
      .toString()); //(u_sum_time / 3600).toStringAsFixed(2) + ' hours';
